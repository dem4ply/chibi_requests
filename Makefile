...
lint: ## check style with flake8
	flake8 chibi_requests tests

coverage: ## check code coverage quickly with the default Python
	coverage run --source chibi_requests setup.py test
	coverage report -m
	coverage html
	$(BROWSER) coverage_html_report/index.html

docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs/chibi_requests.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs/ chibi_requests
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
...
pep8:
	...
	@pycodestyle --statistics chibi_requests tests

flakes:
	@echo "Running flakes tests..."
	@pyflakes chibi_requests tests
